...
<table style="width: 1250px; border-collapse: collapse;">
    ...
    <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">
            <img src="https://github.com/user-attachments/assets/6a93dc0e-c936-41a0-91a2-2f31674c5b5e" alt="녹화_2024_11_25_16_37_40_486" height="670" style="margin: 5px;" />
        </td>
    </tr>
</table>

#### 2. 회원가입
<table style="width: 400px; height:500px; border-collapse: collapse;">
    <tr>
        <th style="text-align: left; padding: 10px; border: 1px solid #ddd;">메인화면</th>
    </tr>
    <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">
 <img src="https://github.com/user-attachments/assets/5ee94157-ad0b-47eb-bc8b-2ce83d2c9a58" width="500" height="600" alt="녹화_2024_11_25_16_37_40_486" style="margin: 5px;" />
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">
                    <p>회원 정보 메인 화면</p>
            <img src="https://github.com/user-attachments/assets/d27f6b75-16d3-40fc-ab12-065289b5173c" alt="화면 캡처 2024-11-25 172611" width="530" />
        </td>
        <td style="padding: 10px; border: 1px solid #ddd;">
                      <p>비밀번호 변경</p>
            <img src="https://github.com/user-attachments/assets/48d910e0-6c5b-445b-833f-5bb9f34998bd" alt="화면 캡처 2024-11-25 172611" width="530" />
        </td>
    </tr>
    <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">
                      <p>닉네임 변경</p>
            <img src="https://github.com/user-attachments/assets/522f8caa-0620-4ae1-bef2-46deab13d3b6" alt="화면 캡처 2024-11-25 172611" width="530" />
        </td>
        <td style="padding: 10px; border: 1px solid #ddd;">
                      <p>계정 삭제</p>
            <img src="https://github.com/user-attachments/assets/bf54035d-ede0-4158-87a3-03b3f5c06a78" alt="화면 캡처 2024-11-25 172611" width="530" />
        </td>
    </tr>
</table>
