    ...
    public class PageController {
        ...
        public ResponseEntity<Page> createPage(@RequestBody PageDto pagedto) {
            ...
            Page newPage = pageService.createPage(pagedto.getTitle(), pagedto.getContent(), pagedto.getPriority(), pagedto.getUserId());
        ...
        public ResponseEntity<Page> updatePriority(@PathVariable Long id, @RequestBody Map<String, Integer> payload) {
            ...
            if (priority == null) {
                return ResponseEntity.badRequest().body(null); // priority가 없을 경우 에러 응답
            }
